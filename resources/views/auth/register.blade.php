    ...
    <x-slot name="slot2">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="Iemand@mail.com"/>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="number" class="block mt-1 w-full" type="tel" name="number" :value="old('number')" maxlength="8" min="8" required placeholder="12345678"/>
