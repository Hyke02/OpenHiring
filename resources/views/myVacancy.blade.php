...
<section class="ml-5 mr-5">
    ...
    <div class=" bg-[#FFFFFF] mb-10 flex flex-col flex-wrap justify-center border-black border-2 rounded-xl border-opacity-50 ml-5 mr-5 p-2 gap-2.5">
        ...
        <x-nav-link href="{{ url(route('vacancy.show',['id' => $vacancyData['vacancy']->id])) }}" class="bg-[#AA0061] text-white px-4 py-2 rounded-md shadow hover[#AA0061] mt-3" > Bekijk vacature nog eens </x-nav-link>
